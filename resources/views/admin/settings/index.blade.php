...
@section('styles')
    <style>
        ...
        .search-bar-wrapper .dataTables_filter input:focus {
            border-color: #0A9051;
        }

        .yajra-table-custom-class table {
            width: 100% !important;
        }
        ...
        .yajra-table-custom-class tbody tr {
            transition: background 0.15s;
        }

        .yajra-table-custom-class tbody tr:hover {
            background: #f0fdf4;
        }

        .yajra-table-custom-class tbody td {
            padding: 0.85rem 1rem;
        ...
        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index:1;">
            <div>
                <h1 class="fw-800 mb-1" style="font-size:1.75rem;">
                    <i class="fa-solid fa-gear me-2 opacity-75"></i>
                    {{ __('labels.settings') }}
                </h1>
                <p class="mb-0 opacity-75">Manage your Setting</p>
            </div>
            {{-- <a href="{{ route('admin.settings.create') }}" 
           class="btn btn-light fw-600 rounded-pill px-4 py-2 d-flex align-items-center gap-2"
           style="color:#004727;">
            <i class="fa-solid fa-plus"></i>
            {{ __('labels.create_new_setting') }}
        </a> --}}

            @if ($hasSettings)
                <button class="btn btn-secondary fw-600 rounded-pill px-4 py-2 d-flex align-items-center gap-2 d-none" disabled 
