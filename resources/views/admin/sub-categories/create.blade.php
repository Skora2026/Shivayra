...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h2 class="mb-0 fw-700" style="font-size:1.4rem;">{{ __('labels.create_new_sub_category') }}</h2>
</div>

<div class="form-card">
    <div class="form-card-header">
        <h5 class="mb-0 fw-600"><i class="fa-solid fa-sitemap me-2"></i> Sub-Category Details</h5>
        <p class="mb-0 opacity-75 mt-1" style="font-size:0.875rem;">Fill in the information below to create a new sub-category.</p>
    </div>
    <div class="form-card-body">
        <form action="{{ route('admin.sub-categories.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            ...
            <div class="d-flex align-items-center gap-3 mt-4 pt-3 border-top">
                <button type="submit" class="btn btn-save px-4">
                    <i class="fa-solid fa-floppy-disk me-2"></i> Save Sub-Category
                </button>
